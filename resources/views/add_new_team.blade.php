...
<div class="page-header d-print-none">
		...
		<div class="page-body">
          ...
          @endif
              ...
              <div class="col-md-12">
              <form class="card" method="post" action="{{url('add_team_action')}}">
			  @csrf
                ...
                <div class="card-body">
				  <div class="mb-3">
                    ...
                    <div>
                      <input type="text" class="form-control" aria-describedby="emailHelp" placeholder="Eg: Sales" name="team_name">
